...
-- -----------------------------------------------------
-- Table `online_shop`.`Carts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `online_shop`.`Carts` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `online_shop`.`Cart_Items` (
  ...
  INDEX `fk_Products_has_Carts_Carts1_idx` (`cart_id` ASC) VISIBLE,
  INDEX `fk_Products_has_Carts_Products1_idx` (`product_id` ASC) VISIBLE,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `fk_Cart_Items_Carts1`
    FOREIGN KEY (`cart_id`)
    REFERENCES `online_shop`.`Carts` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `online_shop`.`User_Adresses`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `online_shop`.`User_Adresses` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `address_id` INT NOT NULL,
  `user_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Addresses_has_Users_Users1_idx` (`user_id` ASC) VISIBLE,
  INDEX `fk_Addresses_has_Users_Addresses1_idx` (`address_id` ASC) VISIBLE,
  CONSTRAINT `fk_Addresses_has_Users_Addresses1`
